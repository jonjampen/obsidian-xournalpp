...
Contributions in any form are welcome! If you'd like to beta test the plugin, follow the instructions [here](https://jonjampen.github.io/obsidian-xournalpp/docs/beta-testing).
